...
namespace v1 
{
    class user: public HttpController<user>
    {
        ...
        public:
            METHOD_LIST_BEGIN
            ADD_METHOD_TO(user::create, "/api/v1/user/", Post, "api::api_token_filter");
            ADD_METHOD_TO(user::create, "/api/v1/user?user_id={1}", Get, "api::api_token_filter");
            ADD_METHOD_TO(user::create, "/api/v1/user/list/", Get, "api::api_token_filter");
            ADD_METHOD_TO(user::create, "/api/v1/user?user_id={1}", Put, "api::api_token_filter");
            ADD_METHOD_TO(user::create, "/api/v1/user?user_id={1}", Delete, "api::api_token_filter");
            METHOD_LIST_END
