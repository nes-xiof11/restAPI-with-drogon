...
namespace v1 
{
    class user: public HttpController<user>
    {
        ...
        public:
            ...
            ADD_METHOD_TO(user::single, "/api/v1/user?user_id={1}", Get, "api::api_token_filter");
            ADD_METHOD_TO(user::list, "/api/v1/user/list/", Get, "api::api_token_filter");
            ADD_METHOD_TO(user::update, "/api/v1/user?user_id={1}", Put, "api::api_token_filter");
            ADD_METHOD_TO(user::remove, "/api/v1/user?user_id={1}", Delete, "api::api_token_filter");
            METHOD_LIST_END
